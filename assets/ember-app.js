...
define('ember-app/mixins/regenerated/models/i-i-s-kurs3-\u0437\u0430\u0433\u0440-\u0444\u0430\u0439\u043B\u0430', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    ...
    modelClass.defineProjection('ЗагрФайлаL', 'i-i-s-kurs3-загр-файла', {
      дата: (0, _attributes.attr)('Дата', { index: 0 }),
      путь: (0, _attributes.attr)('Путь', { index: 3 })
    });
  };
});
